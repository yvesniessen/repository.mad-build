...
WRPMETA_TV_FOLDER = xbmcaddon.Addon('plugin.video.wrp-metaplayer').getSetting('tv_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.wrp-metaplayer)') else None
WRPMETA_MOVIE_FOLDER = xbmcaddon.Addon('plugin.video.wrp-metaplayer').getSetting('movies_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.wrp-metaplayer)') else None
