...
def setup_library(library_folder):
	...
	if not xbmcvfs.exists(library_folder):
		...
		msg = _("Do you want to automatically set the WRP MetaPlayer as the source for TV shows?")
		if plugin.yesno('Library setup', msg):
			try:
				source_thumbnail = plugin.get_media_icon('tv')
				source_name = _("WRP-MetaPlayer TV Shows")
				source_content = "('%s','tvshows','metadata.tvdb.com','',0,0,'<settings version=\"2\"><setting id=\"absolutenumber\" default=\"true\">false</setting><setting id=\"alsoimdb\">true</setting><setting id=\"dvdorder\" default=\"true\">false</setting><setting id=\"fallback\">true</setting><setting id=\"fallbacklanguage\">en</setting><setting id=\"fanart\">true</setting><setting id=\"language\" default=\"true\">de</setting><setting id=\"RatingS\" default=\"true\">TheTVDB</setting><setting id=\"usefallbacklanguage1\">true</setting></settings>',0,0,NULL,NULL)" % library_folder
