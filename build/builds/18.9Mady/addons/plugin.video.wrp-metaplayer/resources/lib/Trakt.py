...
title = _("Authenticate Trakt")
msg1  = _("Do you want to authenticate with Trakt now?")
msg2  = _("Please go to  https://trakt.tv/activate  and enter this code: ")
...
if len(TCI) == 64 and len(TCS) == 64:
	...
	CLIENT_ID     = 'f799680f488c5e3a671940d949bc4e9ab2334ec28545620f5cca33436a1a6691'
	CLIENT_SECRET = 'c6a3bd51c829c13758cd43ca9c8a32bb09b131bd83f30f49392d3e6b11a6a953'
...
def clear_trakt():
	title = _("WRP-MetaPlayer: Clear Trakt account settings")
	msg = _("Reauthorizing Trakt will be required to access My Trakt.[CR][CR]Are you sure?")
