...
def setup_library(library_folder):
	...
	if not xbmcvfs.exists(library_folder):
		...
		msg = _("Do you want to automatically set the WRP MetaPlayer as a video source for movies?")
		if plugin.yesno('Library setup', msg):
			source_thumbnail = plugin.get_media_icon('movies')
			source_name = _("WRP-MetaPlayer Movies")
			source_content = "('%s','movies','metadata.themoviedb.org','',2147483647,1,'<settings version=\"2\"><setting id=\"certprefix\" default=\"true\">Rated </setting><setting id=\"fanart\">true</setting><setting id=\"imdbanyway\">true</setting><setting id=\"keeporiginaltitle\" default=\"true\">false</setting><setting id=\"language\" default=\"true\">de</setting><setting id=\"RatingS\" default=\"true\">TMDb</setting><setting id=\"tmdbcertcountry\" default=\"true\">de</setting><setting id=\"trailer\">true</setting></settings>',0,0,NULL,NULL)" % library_folder
