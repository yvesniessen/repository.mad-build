...
ORDER          = ['fanart-exodusredux', 'fanart-gaia', 'fanart-overeasy', 'fanart-metadatautils', 'fanart-placenta', 'fanart-exodus', 'fanart-lastship', 'fanart-premiumizer', 'fanart-realizer', 'fanart-scrubs', 'fanart-venom', 'fanart-yoda', 'imdb-exodusredux', 'imdb-gaia', 'imdb-overeasy', 'imdb-placenta', 'imdb-exodus', 'imdb-lastship', 'imdb-premiumizer', 'imdb-realizer', 'imdb-scrubs', 'imdb-venom', 'imdb-yoda', 'kitsu-wonderfulsubs', 'login-iagl', 'login-netflix', 'mal-wonderfulsubs', 'omdb-metadatautils', 'omdb-metahandler', 'login-opensubtitles', 'login-opensubsbyopensubs', 'login-orion', 'tmdb-exodusredux', 'login-eis', 'tmdb-gaia', 'tmdb-metadatautils', 'tmdb-eis', 'tmdb-wrp-metaplayer', 'tmdb-overeasy', 'tmdb-placenta', 'tmdb-exodus', 'tmdb-lastship', 'tmdb-premiumizer', 'tmdb-realizer', 'tmdb-scrubs', 'tmdb-seren', 'tmdb-venom', 'tmdb-yoda', 'trakt-wrp-metaplayer', 'trakt-seren', 'tvdb-metahandler', 'tvdb-wrp-metaplayer', 'tvdb-premiumizer', 'tvdb-realizer', 'tvdb-seren', 'location-yahoo', 'ws-wonderfulsubs']
...
LOGINID = {
    ...
    'fanart-exodus': {
		...
		'file'     : os.path.join(LOGINFOLD, 'exodus_fanart'),
    ...
    'tmdb-exodus': {
		...
		'icon'     : os.path.join(ADDONS, 'plugin.video.exodus', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.exodus', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'exodus_tmdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.exodus', 'settings.xml'),
		'default'  : 'tm.user',
		'data'     : ['tm.user'],
		'activate' : ''},
    'imdb-exodus': {
		...
		'icon'     : os.path.join(ADDONS, 'plugin.video.exodus', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.exodus', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'exodus_imdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.exodus', 'settings.xml'),
		'default'  : 'imdb.user',
		'data'     : ['imdb.user'],
		'activate' : ''},
    'fanart-lastship': {
		'name'     : 'Fanart.tv - Lastship',
		'plugin'   : 'plugin.video.lastship',
		'saved'    : 'fanart-lastship',
		...
		'file'     : os.path.join(LOGINFOLD, 'lastship_fanart'),
    ...
    'tmdb-lastship': {
		...
		'icon'     : os.path.join(ADDONS, 'plugin.video.lastship', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.lastship', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'lastship_tmdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.lastship', 'settings.xml'),
		'default'  : 'tm.user',
		'data'     : ['tm.user'],
		'activate' : ''},
    'imdb-lastship': {
		...
		'icon'     : os.path.join(ADDONS, 'plugin.video.lastship', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.lastship', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'lastship_imdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.lastship', 'settings.xml'),
		'default'  : 'imdb.user',
		'data'     : ['imdb.user'],
		'activate' : ''},        
	...
	'tmdb-eis': {
		'name'     : 'TMDb - WRPInfo',
		'plugin'   : 'script.wrpinfo',
		'saved'    : 'tmdb-eis',
		'path'     : os.path.join(ADDONS, 'script.wrpinfo'),
		'icon'     : os.path.join(ADDONS, 'script.wrpinfo', 'resources/icon.png'),
		'fanart'   : os.path.join(ADDONS, 'script.wrpinfo', 'resources/fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'eis_tmdb'),
		'settings' : os.path.join(ADDOND, 'script.wrpinfo', 'settings.xml'),
		'default'  : 'tmdb_api',
		'data'     : ['tmdb_api'],
		'activate' : ''},
	'tmdb-metahandler': {
	...
	'imdb-venom': {
		...
		'data'     : ['imdb.user'],
		'activate' : ''},
	'trakt-wrp-metaplayer': {
		'name'     : 'Trakt - WRP-MetaPlayer',
		'plugin'   : 'plugin.video.wrp-metaplayer',
		'saved'    : 'trakt-wrp-metaplayer',
		'path'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'wrp-metaplayer_trakt'),
		'settings' : os.path.join(ADDOND, 'plugin.video.wrp-metaplayer', 'settings.xml'),
		'default'  : 'trakt_api_client_id',
		'data'     : ['trakt_api_client_id', 'trakt_api_client_secret'],
		'activate' : ''},
	'tmdb-wrp-metaplayer': {
		'name'     : 'TMDb - WRP-MetaPlayer',
		'plugin'   : 'plugin.video.wrp-metaplayer',
		'saved'    : 'tmdb-wrp-metaplayer',
		'path'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'wrp-metaplayer_tmdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.wrp-metaplayer', 'settings.xml'),
		'default'  : 'tmdb_api',
		'data'     : ['tmdb_api'],
		'activate' : ''},
	'tvdb-wrp-metaplayer': {
		'name'     : 'TVDB - WRP-MetaPlayer',
		'plugin'   : 'plugin.video.wrp-metaplayer',
		'saved'    : 'tvdb-wrp-metaplayer',
		'path'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.wrp-metaplayer', 'resources/fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'wrp-metaplayer_tvdb'),
		'settings' : os.path.join(ADDOND, 'plugin.video.wrp-metaplayer', 'settings.xml'),
		'default'  : 'tvdb_api',
		'data'     : ['tvdb_api'],
		'activate' : ''},
