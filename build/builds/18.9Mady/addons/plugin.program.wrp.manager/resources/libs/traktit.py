...
ORDER          = ['exodusredux', 'gaia', 'wrp-metaplayer', 'overeasy', 'placenta', 'exodus', 'lastship', 'premiumizer', 'realizer', 'scrubs', 'seren', 'trakt', 'venom', 'yoda']
...
TRAKTID = {
    ...
    'wrp-metaplayer': {
        ...
        'file'     : os.path.join(TRAKTFOLD, 'wrp-metaplayer_trakt'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.wrp-metaplayer/authenticate_trakt)'},
    'yoda': {
        'name'     : 'Yoda',
