...
URL              = 'https://gitter.im/WRP-Lounge/WRP-Metaplayer'
EXPIRATION       = 2592000
    ...
    def __init__(self):
        ...
        for item in files:
            ...
            if succes:
                ...
                if succes:
                    msg = "Scanne den QR-Code oder lade deine [COLOR %s]%s[/COLOR] Datei, mit einer Beschreibung deines Problems hier:[CR][COLOR %s]%s[/COLOR] hoch. Wir werden dir schnellstmöglichst helfen." % (COLOR1, name, COLOR1, result)
                    # if len(self.email) > 5:
